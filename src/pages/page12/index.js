...
import bg from "./bg12.png";
import shape1 from "./shape23.png";
import shape2 from "./shape24.png";
...
function Page({ redirectToRandomPage }) {
  ...
  return (
    <Box bgImage={`url(${bg})`} bgSize='cover' h='100vh' position='relative'>
      {/* gumbki */}
      <Image
        right='150px' // kolko je oddaljen od desne
      ...
      {isShape1Visible && ( // ce je shape 1 visible, se prikaze slika
        <Image
          ...
          position='absolute' // stays same
          right='320px' // kolko je oddaljen od desne
          top='20px' // kolko je oddaljen od vrha
        />
      )}
      {isShape2Visible && ( // ce je shape 1 visible, se prikaze slika
        <Image
          ...
          top='1390px' // kolko je oddaljen od vrha
        />
      )}
    </Box>
  );
